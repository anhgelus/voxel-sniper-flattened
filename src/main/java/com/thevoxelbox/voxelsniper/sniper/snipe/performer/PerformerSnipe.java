...
public class PerformerSnipe extends Snipe {
    ...
    public PerformerSnipe(final Snipe snipe, final PerformerProperties performerProperties, final Performer performer) {
    ...
    public PerformerSnipe(final Sniper sniper, final Toolkit toolkit, final ToolkitProperties toolkitProperties, final BrushProperties brushProperties, final Brush brush, final PerformerProperties performerProperties, final Performer performer) {
