...
public class SnipeMessageSender {
    ...
    public SnipeMessageSender(final ToolkitProperties toolkitProperties, final BrushProperties brushProperties, final Player player) {
    ...
    public SnipeMessageSender message(final String message) {
