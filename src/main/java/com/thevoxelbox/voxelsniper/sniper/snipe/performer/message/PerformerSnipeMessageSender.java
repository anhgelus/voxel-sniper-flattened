...
public class PerformerSnipeMessageSender extends SnipeMessageSender {
    ...
    public PerformerSnipeMessageSender(final ToolkitProperties toolkitProperties, final BrushProperties brushProperties, final PerformerProperties performerProperties, final Player player) {
