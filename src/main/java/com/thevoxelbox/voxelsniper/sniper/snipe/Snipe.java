...
public class Snipe {
    ...
    public Snipe(final Sniper sniper, final Toolkit toolkit, final ToolkitProperties toolkitProperties, final BrushProperties brushProperties, final Brush brush) {
        this.sniper = sniper;
