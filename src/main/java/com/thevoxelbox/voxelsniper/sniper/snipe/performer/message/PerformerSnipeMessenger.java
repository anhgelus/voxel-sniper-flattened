...
public class PerformerSnipeMessenger extends SnipeMessenger {
    ...
    public PerformerSnipeMessenger(final ToolkitProperties toolkitProperties, final BrushProperties brushProperties, final PerformerProperties performerProperties, final Player player) {
