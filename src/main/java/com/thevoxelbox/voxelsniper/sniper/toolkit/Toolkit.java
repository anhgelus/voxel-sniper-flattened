...
public class Toolkit {
    ...
    public Toolkit(final String toolkitName) {
    ...
    public void addToolAction(final Material toolMaterial, final ToolAction action) {
        this.toolActions.put(toolMaterial, action);
    }

    public boolean hasToolAction(final Material toolMaterial) {
        return this.toolActions.containsKey(toolMaterial);
    }

    @Nullable
    public ToolAction getToolAction(final Material toolMaterial) {
        return this.toolActions.get(toolMaterial);
    }

    public void removeToolAction(final Material toolMaterial) {
        this.toolActions.remove(toolMaterial);
    }

    public Brush useBrush(final BrushProperties properties) {
    ...
    private Brush createBrush(final BrushProperties properties) {
    ...
    @Nullable
    public Brush getBrush(final BrushProperties properties) {
