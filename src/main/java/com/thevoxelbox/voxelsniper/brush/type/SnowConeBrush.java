...
public class SnowConeBrush extends AbstractBrush {
    ...
    private void addSnow(final Snipe snipe, final Block targetBlock) {
    ...
    private int blockDataToSnowLayers(final BlockData blockData) {
    ...
    private void setSnowLayers(final BlockData blockData, final int layers) {
        if (!(blockData instanceof Snow)) {
            return;
        }
        Snow snow = (Snow) blockData;
