...
public class GenerateTreeBrush extends AbstractBrush {
    ...
    private final List<Block> branchBlocks = new ArrayList<>();
    private Undo undo;
    ...
    private void createBranch(final int xDirection, final int zDirection) {
        // Sets branch origin.
    ...
    private void generateLeafNodeBlock(final int x, final int y, final int z) {
    ...
    private void createRoot(final int xDirection, final int zDirection) {
        // Sets Origin.
        int originX = this.blockPositionX;
        int originY = this.blockPositionY;
        int originZ = this.blockPositionZ;
    ...
    private void generateTrunkBlock(final World world, final int x, final int y) {
