...
public class TriangleBrush extends AbstractPerformerBrush {
    ...
    @Override
    public void handleGunpowderAction(final Snipe snipe) { // Add a point
        triangleP(snipe);
    }

    private void triangleA(final Snipe snipe) {
        SnipeMessenger messenger = snipe.createMessenger();
    ...
    private void triangleP(final Snipe snipe) {
        SnipeMessenger messenger = snipe.createMessenger();
    ...
    private void perform(final int brushSize, final double planeConstant, final double heronBig, final double[] cVectorOne, final double[] cVectorTwo, final double[] cVectorThree, final int i, final int i2, final int i3) {
    ...
    private double calculateHeron(final double[] cVectorOne, final double[] cVectorTwo, final double[] cVectorThree, final double[] coordinatesOne, final double[] coordinatesTwo) {
        for (int i = 0; i < 3; i++) {
    ...
    @Override
    public void sendInfo(final Snipe snipe) { // Make the triangle
        SnipeMessenger messenger = snipe.createMessenger();
