...
/**
 * The CloneStamp class is used to create a collection of blocks in a cylinder shape according to
 * the selection the player has set.
 */
public class CloneStampBrush extends AbstractStampBrush {
    ...
    /**
     * The clone method is used to grab a snapshot of the selected area dictated blockPositionY
     * targetBlock.x y z v.brushSize v.voxelHeight and v.cCen.
     * x y z -- initial center of the selection v.brushSize -- the radius of the cylinder
     * v.voxelHeight -- the height of the cylinder c.cCen -- the offset on
     * the Y axis of the selection ( bottom of the cylinder ) as blockPositionY: Bottom_Y =
     * targetBlock.y + v.cCen;
     */
    private void clone(final Snipe snipe) {
        SnipeMessenger messenger = snipe.createMessenger();
        ToolkitProperties toolkitProperties = snipe.getToolkitProperties();
