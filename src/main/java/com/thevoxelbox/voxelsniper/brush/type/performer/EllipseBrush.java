...
public class EllipseBrush extends AbstractPerformerBrush {
    ...
    private void execute(final Snipe snipe, final Block targetBlock) {
    ...
    private void ellipse(final Snipe snipe, final Block targetBlock) {
        try {
    ...
    private void ellipseFill(final Snipe snipe, final Block targetBlock) {
        int ix = this.xscl;
        int iy = this.yscl;
