...
public class SignOverwriteBrush extends AbstractBrush {
    ...
    public SignOverwriteBrush(final File pluginDataFolder) {
     ...
     */
    private void setSingle(final Snipe snipe) {
        Block targetBlock = getTargetBlock();
        if (targetBlock.getState() instanceof Sign) {
     ...
     */
    private void setRanged(final Snipe snipe) {
        ToolkitProperties toolkitProperties = snipe.getToolkitProperties();
        Block targetBlock = getTargetBlock();
     ...
     */
    private int parseSignLineFromParam(final String[] params, final int lineNumber, final Snipe snipe, final int i) {
        int index = i;
        SnipeMessenger messenger = snipe.createMessenger();
    ...
    private void displayBuffer(final Snipe snipe) {
        SnipeMessenger messenger = snipe.createMessenger();
     ...
     */
    private void saveBufferToFile(final Snipe snipe, final String fileName) {
        SnipeMessenger messenger = snipe.createMessenger();
     ...
     */
    private void loadBufferFromFile(final Snipe snipe, final String fileName) {
        SnipeMessenger messenger = snipe.createMessenger();
        File store = new File(this.pluginDataFolder, fileName + ".vsign");
        if (!store.exists()) {
