...
public class ShellSetBrush extends AbstractBrush {
    ...
    private boolean set(final Block block, final Snipe snipe) {
        SnipeMessenger messenger = snipe.createMessenger();
    ...
    private boolean isBlockTypeNotEqual(final World world, final int y, final int x, final int z, final Material replaceBlockDataType) {
