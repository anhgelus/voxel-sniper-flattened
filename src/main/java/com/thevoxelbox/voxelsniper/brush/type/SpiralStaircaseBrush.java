...
public class SpiralStaircaseBrush extends AbstractBrush {
    ...
    private void buildStairWell(final Snipe snipe, final Block targetBlock) {
    ...
    private void digStairWell(final Snipe snipe, final Block targetBlock) {
        ToolkitProperties toolkitProperties = snipe.getToolkitProperties();
        SnipeMessenger messenger = snipe.createMessenger();
        int voxelHeight = toolkitProperties.getVoxelHeight();
        if (voxelHeight < 1) {
    ...
    private void setStairsDirection(final Vector3i position, final int data) {
    ...
    private BlockFace dataToDirection(final int data) {
        switch (data) {
            case 3:
