...
public class CirclePainter implements Painter {
    ...
    public CirclePainter center(final Block block) {
        Vector3i center = Vectors.of(block);
        return center(center);
    }

    public CirclePainter center(final Location location) {
        Vector3i center = Vectors.of(location);
        return center(center);
    }

    public CirclePainter center(final Vector3i center) {
        this.center = center;
        return this;
    }

    public CirclePainter radius(final int radius) {
        this.radius = radius;
        return this;
    }
    ...
    public CirclePainter trueCircle(final boolean trueCircle) {
        this.trueCircle = trueCircle;
        return this;
    }

    public CirclePainter blockSetter(final BlockSetter blockSetter) {
