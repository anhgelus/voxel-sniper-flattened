...
public class CubePainter implements Painter {
    ...
    public CubePainter center(final Block block) {
        Vector3i center = Vectors.of(block);
        return center(center);
    }

    public CubePainter center(final Location location) {
        Vector3i center = Vectors.of(location);
        return center(center);
    }

    public CubePainter center(final Vector3i center) {
        this.center = center;
        return this;
    }

    public CubePainter radius(final int radius) {
        this.radius = radius;
        return this;
    }

    public CubePainter blockSetter(final BlockSetter blockSetter) {
