...
public class SquarePainter implements Painter {
    ...
    public SquarePainter center(final Block block) {
        Vector3i center = Vectors.of(block);
        return center(center);
    }

    public SquarePainter center(final Location location) {
        Vector3i center = Vectors.of(location);
        return center(center);
    }

    public SquarePainter center(final Vector3i center) {
        this.center = center;
        return this;
    }

    public SquarePainter radius(final int radius) {
        this.radius = radius;
        return this;
    }

    public SquarePainter blockSetter(final BlockSetter blockSetter) {
