...
public final class ArtHelper {
     ...
     */
    public static void paint(final Player player, final Art art) {
    ...
    public static void paintAuto(final Player player, final boolean back) {
        Painting bestMatch = matchPainting(player);
        if (bestMatch == null) {
            return;
        }
    ...
    @Nullable
    private static Painting matchPainting(final Player player) {
